      ...
      <div className="bg-slate-900 w-[calc(100vw-80px)] mx-auto h-[100vh] flex justify-center items-center">
        <div className="sm:w-[350px] bg-blue-500 sm:h-[460px] mx-auto relative  my-auto hover:shadow-blue-700 hover:shadow-2xl  shadow-lg shadow-blue-800 rounded-lg flex flex-col justify-center items-center gap-5 w-[80vw] h-[70vh]"> 
          <button disabled = {isloading}
            ...
            className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs w-60 text-center justify-center py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500
             hover:shadow-gray-600 active:bg-slate-500"
          >
            <svg
          ...
          disabled ={isloading}
            ...
            className=" active:bg-slate-500 flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs w-60 justify-center py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
